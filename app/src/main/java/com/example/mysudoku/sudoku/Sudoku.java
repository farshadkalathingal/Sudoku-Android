package com.example.mysudoku.sudoku;

import com.example.mysudoku.Count;
...
public class Sudoku {
    ...
    private List<Cell> getListOfEmptyCells(Cell[] puzzle) {
        ...
        for (Cell cell : puzzle) {
            if (cell.isEmpty()) {
                results.add(cell);
              //  System.out.println("Woww"+results);
            }
        }
    ...
    public String getPuzzleString(Format format) {
       // System.out.println("Woww"+getStringValue(puzzle, format));
    ...
    public String getSolutionString() {
       // System.out.println(getStringValue(solution, null));
    ...
    private static Cell[] copy(Cell[] cells) {
        ...
        for (int i = 0; i < result.length; i++) {
           ...
           // System.out.println("Woww"+result[i]);
        }
